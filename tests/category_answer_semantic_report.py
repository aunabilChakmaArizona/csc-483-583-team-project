"""Report how often question answer titles semantically match their categories."""
...
def evaluate_answer_category_matches(
...
def main() -> None:
    report = evaluate_answer_category_matches()
    print_report(report)
